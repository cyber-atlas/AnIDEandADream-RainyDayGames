 ...
 **/
public class Messaging2 extends ListActivity implements View.OnClickListener {
 ...
 **/
    ...
    public void onClick(View v) {
        ...
        if(v == buttonDest){
            ...
            String serverAddy = "ws://proj309-vc-04.misc.iastate.edu:8080/rude/" + editTextDest.getText().toString().trim();
            try {
